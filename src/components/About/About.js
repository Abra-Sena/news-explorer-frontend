      ...
      <div className="about__content">
        ...
        <div className="about__elements">
          ...
          <p className="about__paragraph">
            My name is Abravi Emiline and this is my final project to complete my web development course at Practicum by Yandex.
          ...
          <p className="about__paragraph">
            ...
            I am currently loving backend and can build a Rest API. In fact, I have my own API for this project.
          </p>
        </div>
      </div>
    </section>
